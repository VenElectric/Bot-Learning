...
module.exports = {
    ...
    async execute(interaction) {
        ...
        if (tag === null || rollAmount === null) {
            await interaction.reply("Please enter a tag and number of dice rolls when you run this command. If you need help with this command, please use the /help slash command.");
        ...
        try {
            ...
            collector.on("end", async (collected) => {
                if (!isReset) {
                    ...
                    await interaction.editReply("Please use the /collectrolls command again to start the collector.");
                }
            });
        }
        catch (error) {
