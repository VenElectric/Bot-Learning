...
module.exports = {
    name: ServerCommunicationTypes_1.EmitTypes.CREATE_NEW_ROLL,
    execute(io, socket, client, data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield addSingle(data.rollData, data.sessionId, ServerCommunicationTypes_1.topLevelCollections.SESSIONS, ServerCommunicationTypes_1.secondLevelCollections.ROLLS);
            socket.broadcast
                .to(data.sessionId)
