...
module.exports = {
    ...
    async execute(io, socket, client, data) {
        ...
        await addSingle(data.rollData, data.sessionId, ServerCommunicationTypes_1.topLevelCollections.SESSIONS, ServerCommunicationTypes_1.secondLevelCollections.ROLLS);
        socket.broadcast
            .to(data.sessionId)
