...
module.exports = {
    ...
    execute(io, socket, client, sessionId, respond) {
        return __awaiter(this, void 0, void 0, function* () {
            const { retrieveCollection } = yield Promise.resolve().then(() => __importStar(require("../../services/database-common")));
            let spells;
            weapon_of_logging.debug({
                message: "retrieving initial spell data",
                function: ServerCommunicationTypes_1.EmitTypes.GET_SPELLS,
            });
            spells = yield retrieveCollection(sessionId, ServerCommunicationTypes_1.secondLevelCollections.SPELLS);
