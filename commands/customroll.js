...
module.exports = {
    ...
    execute(interaction) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            (0, database_common_1.addSingle)({ rollName: rollName, id: String((0, uuid_1.v4)()), rollValue: customRoll }, interaction.channel.id, ServerCommunicationTypes_1.collectionTypes.ROLLS);
